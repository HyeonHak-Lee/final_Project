	...
	<!--  헤더 불러오고 -->
	    ...
	    <div class="own-content j4">
	        ...
	        <div class="join-form">
	            ...
	            <div class="tbl-caption frst">ID/비밀번호 변경</div>
	            <table class="table-style1">
	                ...
	                <tr>
	                    <th>ID <em></em></th>
	                    <td>
	                        <input type="text" class="w-l" name="shop_id" disabled="disabled">
	                    </td>
	                </tr>
	            ...
	            <div class="tbl-caption frst">사업자 정보 변경</div>
	            <table class="table-style1">
	                <colgroup>
	                    <col style="width: 150px">
	                    <col>
	                ...
	                <tbody><tr>
	                    ...
	                    <!-- 사업자 번호입력란
	                     ...
	                     -->
	                        ...
	                        <input type="text" class="w-s" name="cn1" numberonly="true" maxlength="3" disabled="disabled"> <span class="bar">-</span>
	                        <input type="text" class="w-s" name="cn2" numberonly="true" maxlength="2" disabled="disabled"> <span class="bar">-</span>
	                        <input type="text" class="w-s" name="cn3" numberonly="true" maxlength="5" disabled="disabled">
	            ...
	            <div class="tbl-caption">가게 정보 변경</div>
	            <table class="table-style1">
	                <colgroup>
	                    <col style="width: 150px">
	                    <col>
	                ...
	                <tbody><tr>
	                    <th>가게 이름</th>
	                    <td>
	                        <input type="text" class="w-l" maxlength="20" name="shop_name" disabled="disabled">
	                    </td>
	                </tr>
	                <tr>
	                    <th>가게 전화번호</th>
	                ...
	                <!-- 이부분은 db에서 카테고리 속성값 불러와서 로딩하기 -->
	                    ...
	                    <td>
	                        ...
	                        <select name="category" disabled="disabled">
	                            <option value="">-현재 카테고리 표시-</option>
	            ...
	            <!-- 이부분 나중에 수정하기 -->
	                <button type="submit" class="btn-type1" name="save_button">수정 완료</button>
	            </div>
	        </div>
