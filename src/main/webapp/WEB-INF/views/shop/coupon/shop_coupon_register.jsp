        ...
        <div id="container">
            ...
            <div id="content">
                ...
                <div class="headingArea">
                    <div class="mTitle">
                        <h1>쿠폰 관리</h1>
                        <span class="cManual eSmartMode" code="PN.PN.CI"><a href="//serviceguide.cafe24.com/IN/ko_KR/PN.PN.CI.html" target="_blank" class="btnManual" title="새창 열림">매뉴얼</a></span>
                    </div>
                    ...
                    <div class="mAdBanner">
                        <span id="admngDebug"></span><span id="admngSide_1"><a href="#"><img src="//m-img.cafe24.com/images/event/2021/02/hjs_400X56.jpg" name="admngPopImage"></a><img id="admngViewImage_5808_43506" src="https://ad.cafe24.com/adManager/controller/ConclusionViewAD.php?idx=43506&amp;siteType=malladmin&amp;groupIdx=5808&amp;parentAdIDX=" style="display: none;"></span>
                        <script id="admng" type="text/javascript" src="//ad.cafe24.com/adManager/logic/WebAnalysis.js?siteType=malladmin&amp;userID=ydh312&amp;groupIdx=5808"></script>
                    </div>
                </div>
				...
				<!-- 쿠폰페이지 검색부분 -->
                <%@include file="coupon_register.jsp" %>
                <!-- 쿠폰 일괄 관리 -->
                <form id="mIssueForm">
